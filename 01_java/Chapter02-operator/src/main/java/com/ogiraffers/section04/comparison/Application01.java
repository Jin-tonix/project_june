...
public class Application01 {
    public static void main(String[] args){
        ...
        * '<' : 왼쪽의 피연산자와 오른쪽의 피연산자가 작으면 true 다르면 false를 반환한다.
        * '<=' : 왼쪽의 피연산자와 오른쪽의 피연산자가 작거나 같으면 true 다르면 false를 반환
        ...
        System.out.println("inum1과 inum2가 같거나 큰지 비교 : " + (inum1 >= inum2)); //false
        System.out.println("inum1과 inum2가 같거나 작은지 비교 : " + (inum1 <= inum2)); //true
