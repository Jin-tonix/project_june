...
public class Application03 {
    public static void main (String[] args){
        ...
        */
        ...
        int result3 = (false && ++num1 <0)? num1 : 20;
        int result4 = (true && ++num1 < 0)? num1 : 20;
        int result5 = (true && ++num1 > 0)? num1 : 20;
        ...
        /*
        *논리식 || 논리식 : 앞의 결과가 true이면 뒤를 시행하지 않음
        * 조건식 둘 중 하나라도 true를 반환하면 true를 반환하기 떄문에 앞에서 미리 true가 나오게 되면
        ...
        * 따라서 연산 횟수를 줄이기 위해서는 ||연산자의 경우 앞에 true가 나올 가능성이 높은 조건을 작성하는 편이 좋다.
        ...
        int result6 = (false || ++num2 >0)? num2 :20;
        int result7 = (false || ++num2 <0)? num2 :20;
